...
<%
Response.write "|" & Request("HarvestAmericanPassword") & now() & "|<br>"
...
'response.write "Session('ha_login'): " & Session("ha_login") & "<br>"
'response.write "Password: " & Request("HarvestAmericanPassword") & "<br>"
...
%>
					...
					<form method="post" action="/mobile/mLogin.asp" name="frm">
	               	<tr>
