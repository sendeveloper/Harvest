...
<%
	...
	Response.write "<tr><td colspan='2'><span style='font-weight: bold; color: #336600;'>Background Processes</span></td></tr>"
...
%>
    ...
    <td width="25%" valign="top">
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
	    <tr>
		  <td>
			<span style="font-weight: bold; color: #336600;">Monthly Research Status</span>
		  </td>
		</tr>
