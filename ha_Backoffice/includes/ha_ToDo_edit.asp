...
<head>
	...
	<script type="text/javascript">
      ...
      function clickEditSave()
			...
			alert(note);
			//var URL = 'ha_ToDo_edit.asp?Mode='+ Mode +'&a='+ Mode +'&ID=<%=ID%>&noteid='+ noteID +'&Category=ToDo&Note='+note;
			//alert(URL);
