...
sqlConnectionString = "Driver=SQL Server;server=66.119.55.118,7043;uid=davewj2o;pwd=get2it;database=ha_Backoffice"
...
Function SqlNewConnection()
  ...
  If sqlDebug = True Then
    Response.Write("<br>Connecting: " & sqlConnectionString & "<br>" & chr(13))
  End If
...
Function Sql(sqlText)
  ...
  If sqlDebug = True Then
    rs.open sqlText, connCasper10, 2, 1
  Else
