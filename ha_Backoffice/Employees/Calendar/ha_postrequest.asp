...
<body>
  <%
    ...
    'If Request("rMode") = "Edit" and Session("ha_login") = "teresa" Then
    ...
    'End If
      ...
      If Request("rMode") = "Edit" and Session("ha_login") = "teresa" Then
		...
		Elseif Request("rMode") = "Edit" and Session("ha_login") = "davewj2o" Then
        rs("IsApproved") = Request("IsApproved")
        rs("AppReason") = fixaps(Request("AppReason"))
      ...
      If Request("rmode") = "Add" Then
        emailTarget = "teresa@harvestamerican.com"
        emailSubject = "Time Off Request - " & Request("RequestedBy")
        emailOriginate = "mailserver@harvestamerican.email"
        Set rs = Server.CreateObject("ADODB.Recordset")
        rs.Open "SELECT * FROM ha_EmpAccounts WHERE FirstName = '" & Request("RequestedBy") & "'", connCasper10, 1, 3
        emailCopy = rs("Email")
        rs.Close
        emailBody = "Greetings Teresa, " & chr(13) & "There is a new time off request from " & Request("RequestedBy") & " available for viewing at /ha_BackOffice/Company/ha_timerequest.asp.  Please check it at your soonest convenience!" & chr(13) & chr(13) & "This is a system message.  Please do not reply to this message."
      Else
        If Session("ha_login") = "teresa" Then
          rs.Open "SELECT * FROM ha_EmpAccounts WHERE FirstName = '" & Request("RequestedBy") & "'", connCasper10, 1, 3
          emailTarget = rs("FirstName") & " " & fixaps(rs("LastName")) & "<" & rs("Email") & ">"
          emailSubject = "RE: Your Time Off Request"
          emailOriginate = "Teresa Stevens <teresa@harvestamerican.com>"
          emailCopy = "Teresa Stevens <teresa@harvestamerican.com>"
          rs.Close
          emailBody = "Greetings " & Request("RequestedBy") & ", " & chr(13)
          
          If Request("IsApproved") = 1 Then
            emailBody = emailBody & "I am pleased to inform you that I have approved your request for time off. Enjoy!" & chr(13) & chr(13) & "Sincerely," & chr(13) & chr(13) & "Teresa"
          Else
            emailBody = emailBody & "Unfortunately, I am unable to approve your request for time off for the following reason: " & chr(13) & chr(13) & Request("AppReason") & chr(13) & chr(13) & "I hope you understand why I had to do this.  If you do not, please do not hesitate to get in touch with me." & chr(13) & chr(13) & "Sincerely," & chr(13) & chr(13) & "Teresa"
          End If
        Else
          emailTarget = "teresa@harvestamerican.com"
          emailSubject = "Time Off Request - " & Request("RequestedBy")
          ...
          emailCopy = rs("Email")
          rs.Close
          emailBody = "Greetings Teresa, " & chr(13) & "There is a new time off request from " & Request("RequestedBy") & " that was corrected and is available for viewing at /ha_BackOffice/Company/ha_timerequest.asp.  Please check it at your soonest convenience!" & chr(13) & chr(13) & "This is a system message.  Please do not reply to this message."
        End If
      End If
