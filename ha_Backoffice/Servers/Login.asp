...
response.write SQL & "|<br>"
        ...
        if Session("LoggedIn") = "True" then
           if Session("Redirect") = "" then
              Response.Redirect "https://www.HarvestAmerican.org/menu/"
           else
              Response.Redirect "https://www.HarvestAmerican.org" & Session("redirect")
           end if
        end if    
    end if
%>
...
<!--#include virtual="menu/includes/ha_menu.inc"-->
	...
	<div id="columnA">
      ...
      <br><br>
      <table width="400" border="1" cellspacing="0" cellpadding="0" align="center" bgColor="#FFFFFF">
