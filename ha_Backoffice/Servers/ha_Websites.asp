...
<%
	...
	Call FilterCategories("Server", "", "", "", "")
	Call CheckBoxReadTable(1, "ha_Websites", "Server")
%>
...
<%
		strSQL = "ha_Website_list('" & CheckBoxes(1,0) & "', '" & OrderBy & "', '" & Request("SearchText") & "')"
