...
<html>
<head>
    <title>Harvest American Backoffice - Blank</title>
...
<body class="gray_desktop">
  <table align="center" cellspacing="0" cellpadding="0" class="MainBody">
		  ...
		  <td align="center">
			<table width="95%" border="0" cellspacing="5" cellpadding="5">
			  ...
			  <tr valign="top">
				...
				<th class="Heading1" colspan="2">Backup 1</th>
				<th class="Heading1" colspan="2">Backup 2</th>
			  </tr>
	...
	<%
		...
		SQL = "SELECT * FROM ha_Archive_info WHERE Class = 'Backup' ORDER BY SourceClient"
