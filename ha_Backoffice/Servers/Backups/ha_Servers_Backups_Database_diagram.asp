  ...
  <tr>
    <td colspan="2">
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
		...
		<tr>
		  <td>
			The Barley Databases are backed up in once place on D:Casper10.  All the other Servers are backed up to their
			own local D: drive and then a 2nd time on a different server.
		  </td>
		</tr>		
		
		<tr>
		  <td align="center">
			<img src="/ha_BackOffice/Company/DocumentMaintenance/ha_Document_Show.asp?PhotoID=1113">
		  </td>
		</tr>
