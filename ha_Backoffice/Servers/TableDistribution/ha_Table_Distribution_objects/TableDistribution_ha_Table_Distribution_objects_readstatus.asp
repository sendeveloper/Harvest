...
<%
    ...
    response.write "<ha_Table_Distribution_objects_status>"
	...
	Else
		...
		SQL = "ha_TableDistribution_ha_Table_Distribution_objects_status('" & RequestDatabase & "')"		
	...
	'Post to Task Log
	Task = ExecBy & " --> ha_Table_Distribution_objects_Status: " & RequestServer & " " & RequestDatabase
