...
<%
	TableName = "z2t_TableDownload_log"
...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {
		/*
		if (locationServer[loopStep].substring(0, 6) != 'Barley' && locationServer[loopStep].substring(0, 6) !='Philly')
			{
		...
		*/
		...
		var url = '<%=strPathServers%>TableDistribution/z2t_TableDownload_log/TableDistribution_z2t_TableDownload_log_readstatus.asp' + 
    ...
    function runDestinationCount() 
        {
		var url = '<%=strPathServers%>TableDistribution/z2t_TableDownload_log/TableDistribution_z2t_TableDownload_log_Destinations_readstatus.asp' + 
			'?Now=' + escape(Date())
		//alert(url);
