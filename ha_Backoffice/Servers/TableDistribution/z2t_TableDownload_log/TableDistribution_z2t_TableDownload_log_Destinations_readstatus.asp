...
<%
	...
	'Philly05
	ConnString = "driver=SQL Server;server=208.88.49.22,8543;uid=davewj2o;pwd=get2it;database=z2t_WebReporting"
	conn.Open ConnString
	
	SQL = "z2t_TableDownload_log_counts"
	rs.open SQL, conn, 3, 3, 4

	If not rs.eof then
		response.write "<destination>"
			response.write "<server>Philly05</server>"	
			response.write "<database>z2t_WebReporting</database>"	
	...
	'Post to Task Log
	Task = ExecBy & " --> z2t_TableDownload_log_Destinations_Status"
