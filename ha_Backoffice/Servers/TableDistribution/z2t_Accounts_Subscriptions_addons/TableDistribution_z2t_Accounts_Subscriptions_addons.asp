...
<%
	TableName = "z2t_Accounts_Subscriptions_addons"
...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_Accounts_Subscriptions_addons/TableDistribution_z2t_Accounts_Subscriptions_addons_readstatus.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&ExecBy=TableDistribution_z2t_Special_Rules.asp' + 
			'&Now=' + escape(Date());
		//alert(url);
	...
	function runUpdate() 
		...
		var url = '<%=strPathServers%>TableDistribution/z2t_Accounts_Subscriptions_addons/TableDistribution_z2t_Accounts_Subscriptions_addons_update.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&ExecBy=TableDistribution_z2t_Accounts_Subscriptions_addons.asp' + 
			'&Now=' + escape(Date());
