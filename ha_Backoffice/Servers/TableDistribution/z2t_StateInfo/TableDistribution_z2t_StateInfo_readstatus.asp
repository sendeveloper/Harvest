...
<%
    ...
    response.write "<z2t_StateInfo_status>"
	...
	Else
		...
		SQL = "ha_TableDistribution_z2t_StateInfo_status('" & RequestDatabase & "')"		
		...
		'	SQL = "TableDistribution_z2t_StateInfo_status('" & RequestServer & "', '" & RequestDatabase & "')"
		'Case "PHILLY"
		...
		'	conn.Open ConnString
		'	SQL = "z2t_StateInfo_status('" & RequestServer & "', '" & RequestDatabase & "')"
		'Case Else
		'	conn.Open ReadConnection(RequestServer, RequestDatabase)
		'	SQL = "z2t_StateInfo_status"
		'End Select
	...
	'Post to Task Log
	Task = ExecBy & " --> z2t_StateInfo_status: " & RequestServer & " " & RequestDatabase
