...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_StateInfo/TableDistribution_z2t_StateInfo_readstatus.asp' +
	...
	function runUpdate() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_StateInfo/TableDistribution_z2t_StateInfo_update.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&ExecBy=TableDistribution_z2t_StateInfo.asp' + 			
			'&Now=' + escape(Date());
		//alert(url);
