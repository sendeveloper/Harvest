...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {		
		var url = '<%=strPathServers%>TableDistribution/ni_Accounts/TableDistribution_ni_Accounts_readstatus.asp' +
	...
	function runUpdate() 
        {		
		var url = '<%=strPathServers%>TableDistribution/ni_Accounts/TableDistribution_ni_Accounts_update.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&Start=' + aRecStart +
			'&End=' + aRecEnd +
