...
<%
    ...
    response.write "<z2t_EffectiveDates_update>"
	...
	Else
		...
		SQL = "ha_TableDistribution_z2t_EffectiveDates_update('" & RequestDatabase & "')"
		...
		'		SQL = "z2t_EffectiveDates_update('" & RequestServer & "', '" & RequestDatabase & "')"
		'	Case "PHILLY"
		...
		'		SQL = "z2t_EffectiveDates_repl_Table_refresh"
		'	End Select
	...
	'Post to Task Log
	Task = ExecBy & " --> z2t_EffectiveDates_Update: " & RequestServer & " " & RequestDatabase & " " & AccountID
