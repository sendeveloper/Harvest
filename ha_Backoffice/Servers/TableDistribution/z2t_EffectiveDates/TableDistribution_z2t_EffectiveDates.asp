...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_EffectiveDates/TableDistribution_z2t_EffectiveDates_readstatus.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&ExecBy=TableDistribution_z2t_EffectiveDates.asp' + 
			'&Now=' + escape(Date());
		//alert(url);
	...
	function runUpdate() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_EffectiveDates/TableDistribution_z2t_EffectiveDates_update.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&ExecBy=TableDistribution_z2t_EffectiveDates.asp' + 
			'&Now=' + escape(Date());
