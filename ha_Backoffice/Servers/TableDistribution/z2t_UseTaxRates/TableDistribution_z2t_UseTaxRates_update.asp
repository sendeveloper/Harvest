...
<%
	...
	TaskName = "TableDistribution_z2t_UseTaxRates_Update (Full)"
    ...
    response.write "<z2t_UseTaxRates_update>"
	...
	Else
		...
		SQL = "ha_TableDistribution_z2t_UseTaxRates_update('" & RequestDatabase & "', " & _
	...
	'Post to Task Log
	Task = RequestExecBy & " --> z2t_UseTaxRates_Update: " & RequestServer & " " & RequestDatabase
