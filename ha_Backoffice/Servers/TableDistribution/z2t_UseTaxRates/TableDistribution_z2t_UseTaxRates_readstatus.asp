...
<%
    ...
    response.write "<z2t_UseTaxRates_status>"
	...
	Else
		...
		SQL = "ha_TableDistribution_z2t_UseTaxRates_status('" & RequestDatabase & "')"		
	...
	'Post to Task Log
	Task = ExecBy & " --> z2t_UseTaxRates_Status: " & RequestServer & " " & RequestDatabase
