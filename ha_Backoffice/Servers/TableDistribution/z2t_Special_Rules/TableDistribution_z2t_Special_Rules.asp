...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_Special_Rules/TableDistribution_z2t_Special_Rules_readstatus.asp' +
	...
	function runUpdate() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_Special_Rules/TableDistribution_z2t_Special_Rules_update.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&ExecBy=TableDistribution_z2t_Special_Rules.asp' + 
			'&Now=' + escape(Date());
