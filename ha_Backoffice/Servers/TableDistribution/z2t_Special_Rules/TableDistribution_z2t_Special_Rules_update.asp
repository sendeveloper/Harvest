...
<%
    ...
    response.write "<z2t_Special_Rules_update>"
	...
	Else
		...
		Case "CASPER"
			...
			SQL = "z2t_Special_Rules_update('" & RequestServer & "', '" & RequestDatabase & "')"
		Case "PHILLY"
		...
		Case Else
			...
			SQL = "z2t_Special_Rules_repl_Table_refresh"
		End Select
	...
	'Post to Task Log
	Task = ExecBy & " --> z2t_Special_Rules_Update: " & RequestServer & " " & RequestDatabase & " " & AccountID
