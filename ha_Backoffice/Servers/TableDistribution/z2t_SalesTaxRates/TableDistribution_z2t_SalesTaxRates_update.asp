...
<%
	...
	TaskName = "TableDistribution_z2t_SalesTaxRates_Update (Full)"
    ...
    response.write "<z2t_SalesTaxRates_update>"
	...
	Else
		...
		SQL = "ha_TableDistribution_z2t_SalesTaxRates_update('" & RequestDatabase & "', " & _
