...
<%
    ...
    response.write "<z2t_SalesTaxRates_status>"
	...
	Else
		...
		SQL = "ha_TableDistribution_z2t_SalesTaxRates_status('" & RequestDatabase & "')"		
	...
	'Post to Task Log
	Task = ExecBy & " --> z2t_SalesTaxRates_Status: " & RequestServer & " " & RequestDatabase
