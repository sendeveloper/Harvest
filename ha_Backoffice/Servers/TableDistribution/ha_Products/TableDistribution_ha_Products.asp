...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {		
		var url = '<%=strPathServers%>TableDistribution/ha_Products/TableDistribution_ha_Products_readstatus.asp' +
	...
	function runUpdate() 
        {		
		var url = '<%=strPathServers%>TableDistribution/ha_Products/TableDistribution_ha_Products_update.asp' +
			'?s=' + locationServer[loopStep] +
			'&d=' + locationDatabase[loopStep] +
			'&Now=' + escape(Date());
		//alert(url);
