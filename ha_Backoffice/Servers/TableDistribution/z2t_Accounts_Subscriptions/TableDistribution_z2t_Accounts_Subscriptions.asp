...
<%
	...
	StartEndData = "&Start=1&End=100" 'Use for the AJAX debug url
...
<script language='JavaScript'>
    ...
    function runStatusCheck() 
        {		
		var url = '<%=strPathServers%>TableDistribution/z2t_Accounts_Subscriptions/TableDistribution_z2t_Accounts_Subscriptions_readstatus.asp' +
