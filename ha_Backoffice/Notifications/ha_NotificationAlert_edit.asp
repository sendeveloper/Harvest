...
<%
	...
	Else
		Title = "Edit Notification Alerts"
		strSQL = "ha_NotificationAlerts_read(" & Request("rec") & ")"
		...
		If Not rs.eof Then
			...
			eTaskLogSearchCriteriaTaskName		= Null2Space(rs("TaskLogSearchCriteriaTaskName"))
			eTaskLogSearchCriteriaTask			= Null2Space(rs("TaskLogSearchCriteriaTask"))
			eTaskLogSearchCriteria				= Null2Space(rs("TaskLogSearchCriteria"))
		End If
		rs.Close	
    End If
...
<body onload="SetScreen(800,650)">
  <form action="ha_NotificationAlert_post.asp?ID=<%=ID%>" method="post" name="frm">
...
%>
			...
			<tr><td width="400">Search CriteriaTask Name	: </td><td><input id="TaskLogSearchCriteriaTaskName" name="TaskLogSearchCriteriaTaskName" type="text" value="<%=eTaskLogSearchCriteriaTaskName%>"/></td></tr>
			<tr><td>Search Criteria Task:</td><td><input id="TaskLogSearchCriteriaTask" name="TaskLogSearchCriteriaTask" type="text" value="<%=eTaskLogSearchCriteriaTask%>"/></td></tr>
			<tr><td>Search Criteria:</td><td><input id="TaskLogSearchCriteria" name="TaskLogSearchCriteria" type="text" value="<%=eTaskLogSearchCriteria%>"/><td></tr>
			<tr><td>&nbsp;</td></tr>
