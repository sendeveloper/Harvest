...
<%
	Title = "Notification Sensors Flow Chart"	
%>
  ...
  <tr>
    <td colspan="2">
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
		...
		<tr>
		  <td>
			Sensors constantly probe the system reporting results to the task log.
		  </td>
		</tr>
		...
		<tr>
		  <td align="center">
			<img src="/ha_BackOffice/Company/DocumentMaintenance/ha_Document_Show.asp?PhotoID=1486">
		  </td>
		</tr>
