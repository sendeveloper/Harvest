...
<%
	Title = "Notification Alerts Flow Chart"	
%>
  ...
  <tr>
    <td colspan="2">
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
		...
		<tr>
		  <td>
			The Notification Alerts search the Task Log looking for abnormalities.  When one is found it triggers
			a notification.
		  </td>
		</tr>
		...
		<tr>
		  <td align="center">
			<img src="/ha_BackOffice/Company/DocumentMaintenance/ha_Document_Show.asp?PhotoID=1487">
		  </td>
		</tr>
