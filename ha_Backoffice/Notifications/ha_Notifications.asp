...
<head>
  ...
  <%
    ...
    If Request("action") = "delete" Then
      strSQL = "UPDATE ha_ToDo SET DeletedDate = GETDATE(), DeletedBy = '" & Session("ha_shortname") & "' WHERE ID = " & Request("ID")
...
%>
  ...
  <script type="text/javascript">
	...
	function clickOverview()
		{
        var URL = 'ha_Notifications_overview.asp'
        openPopUp(URL);
		}
        ...
        <table class="MainTable">
		  ...
		  <tr valign="top">
		    <td width="16%">
  		    ...
  		    <td width="84%">
			  <div class="ListBody">
				<%=TopRightLinksExpanded("", "", "", "", "", "", "", "", "", "Overview")%>
...
<%
		strSQL = "ha_Notification_list('" & CheckBoxes(1,0) & "', '" & CheckBoxes(2,0) & "', " & _
