...
<body onLoad="SetScreen(1000,900);">
  ...
  <tr>
    <td colspan="2">
      ...
      <table width="95%" border="0" cellspacing="2" cellpadding="2" align="center">
		...
		<tr>
		  <td>
			The Notification System will alert users of various events at may happen
			within the Harvest American system.  An event can be anything from a server not responding
			to a new order was placed.  The user gets to select which events they wish to be notified
			of and what method of notification (E-mail or text).
		  </td>
		</tr>
		...
		<tr>
		  <td align="center">
			<img src="/ha_BackOffice/Company/DocumentMaintenance/ha_Document_Show.asp?PhotoID=1460">
		  </td>
		</tr>
