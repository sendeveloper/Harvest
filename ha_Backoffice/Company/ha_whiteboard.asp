...
<%
  ...
  sqlTableInsert("select * from openrowset('msdasql','DRIVER=Microsoft Excel Driver (*.xls, *.xlsx, *.xlsm, *.xlsb);UserCommitSync=Yes;Threads=3;SafeTransactions=0;ReadOnly=1;PageTimeout=5;MaxScanRows=8;MaxBufferSize=2048;FIL=excel 12.0;DriverId=1046;DefaultDir=G:\office-share\Personal\Angel\Staff Meeting Minutes 2011\;DBQ=ToDoList_2013_07_11.xlsx', 'select * from [ToDoListBreakRoom$]') -- ToDoListBreakRoom -- RateLookupToDoList")
  sqlConn.Close()
%>
    </article>
    </div>
