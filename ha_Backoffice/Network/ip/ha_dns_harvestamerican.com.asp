    ...
    <body class="gray_desktop">
        ...
        <tr> 
            <td>
                ...
                <tr>
                    <td align="center">
                        <span class="newStyleHeading">DNS Mappings for HarvestAmerican.com</span><br>
                        <table class="boarderedtable">
                            ...
                            <tr class="boarderedtable">
                                ...
                                <td class="boarderedtable">harvestamerican.com</td>
                            </tr>
                            <tr class="boarderedtable">
                                <td class="boarderedtable">66.119.50.229</td>
                                <td class="boarderedtable">secret</td>
                            </tr>
                            <tr class="boarderedtable">
