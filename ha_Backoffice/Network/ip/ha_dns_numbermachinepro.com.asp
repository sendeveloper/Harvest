    ...
    <body class="gray_desktop">
        ...
        <tr> 
            <td>
                ...
                <tr>
                    <td align="center">
                        <span class="newStyleHeading">DNS Mappings for NumberMachinePro.com</span><br>
                        <table class="boarderedtable">
                            ...
                            <tr class="boarderedtable">
                                ...
                                <td class="boarderedtable">Staging</td>
                            </tr>
                            <tr class="boarderedtable">
                                <td class="boarderedtable">67.225.195.119</td>
                                <td class="boarderedtable">mail</td>
                            </tr>
                            <tr class="boarderedtable">
                                <td class="boarderedtable">69.16.238.67</td>
                                <td class="boarderedtable">wp</td>
                            </tr>
                        </table>
                    <hr>
                    </td> 
