...
'response.write "|" & Request("pass") & "|<br>"
    ...
    Dim strPathBase
    Dim strPathIncludes
    Dim strPathControlPanel
    Dim strPathMenuIncludes
    Dim strPathMenuImages
    Dim strPathMobile

	Dim strPathBOBase
	Dim strPathBOIncludes
    Dim strPathServers
    Dim strPathTelephones
    ...
    strPathBOBase       =  strPathBase & "/ha_BackOffice/"
    strPathBOIncludes   =  strPathBOBase & "includes/"
	strPathTelephones   =  strPathBOBase & "telephones/"
    strPathServers      =  strPathBOBase & "servers/"
...
'    end if
    ...
    Dim connDallas
    Set connDallas = Server.CreateObject("ADODB.Connection")
